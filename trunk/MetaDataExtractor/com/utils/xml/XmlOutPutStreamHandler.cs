...
namespace com.utils.xml
{
    ...
    public class XmlOutPutStreamHandler : IOutPutTextStreamHandler
    {
        ...
        {
            FileStream lcStream = null;
            StreamReader lcStreamReader = null;
            try
            {
                
                lcStream = File.Open(this.DtdFileName, FileMode.Open, FileAccess.Read);
                lcStreamReader = new StreamReader(lcStream);
